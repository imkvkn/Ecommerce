...
public class CartControllerTest {
    ...
    @Test
    public void verifyAddToCartOKResponse() {
        when(userRpository.findByUsername("vinod")).thenReturn(user);
        when(itemRepository.findById(100L)).thenReturn(Optional.of(items.get(0)));

        modifyCartRequest.setUsername("vinod");
    ...
    public void verifyAddToCartRetuns404WhenUserNotFound() {
        when(userRpository.findByUsername("nonuser")).thenReturn(null);

        modifyCartRequest.setUsername("nonuser");
    ...
    public void verifyAddToCartReturns404WhenItemNotFound() {
        when(userRpository.findByUsername("nonitem")).thenReturn(user);
        when(itemRepository.findById(200L)).thenReturn(Optional.ofNullable(null));

        modifyCartRequest.setUsername("nonitem");
