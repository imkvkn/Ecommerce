...
public class OrderControllerTest {
    ...
    public void verifySubmit() {
        when(userRepository.findByUsername("vinod")).thenReturn(user);
        ResponseEntity<UserOrder> userOrderResponseEntity = orderController.submit("vinod");
    ...
    public void verify404WhenUsernameNotFound() {
        when(userRepository.findByUsername("grammar")).thenReturn(null);
        ResponseEntity<UserOrder> userOrderResponseEntity = orderController.submit("grammar");
    ...
    public void verifyGetOrdersForUser() {
        ...
        ResponseEntity<List<UserOrder>> responseEntity = orderController.getOrdersForUser("vinod");
    ...
    public void verify404WhenUserDoesNotExist() {
        when(userRepository.findByUsername("nonuser")).thenReturn(null);
        ResponseEntity<List<UserOrder>> responseEntity = orderController.getOrdersForUser("nonuser");
